    ...
    : public IAggregateFunctionDataHelper<AggregateFunctionGroupUniqArrayGenericData, AggregateFunctionGroupUniqArrayGeneric<is_plain_column, Tlimit_num_elem>>
{
    ...
    using KeyHolder = typename std::conditional<is_plain_column,
        ArenaKeyHolder, SerializedKeyHolder>::type;

    static KeyHolder getKeyHolder(const IColumn & column, size_t row_num, Arena & arena)
    {
