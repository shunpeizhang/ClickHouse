...
template <typename T>
inline StringRef toStringRef(const T & t)
{
    return StringRef{reinterpret_cast<const char *>(&t), sizeof(t)};
}

template <>
inline StringRef toStringRef(const StringRef & t)
{
    return t;
}
