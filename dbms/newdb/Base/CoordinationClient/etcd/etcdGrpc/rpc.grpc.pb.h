  ...
  class ExperimentalWithCallbackMethod_MemberPromote : public BaseClass {
   ...
   public:
    ExperimentalWithCallbackMethod_MemberPromote() {
      ::grpc::Service::experimental().MarkMethodCallback(4,
        new ::grpc::internal::CallbackUnaryHandler< ::etcdserverpb::MemberPromoteRequest, ::etcdserverpb::MemberPromoteResponse>(
          [this](::grpc::ServerContext* context,
    ...
    void SetMessageAllocatorFor_MemberPromote(
      ...
      static_cast<::grpc::internal::CallbackUnaryHandler< ::etcdserverpb::MemberPromoteRequest, ::etcdserverpb::MemberPromoteResponse>*>(
          ::grpc::Service::experimental().GetHandler(4))
              ->SetMessageAllocator(allocator);
    }
