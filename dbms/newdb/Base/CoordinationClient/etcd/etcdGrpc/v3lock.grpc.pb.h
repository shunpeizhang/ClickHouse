   ...
   public:
    ExperimentalWithCallbackMethod_Lock() {
      ::grpc::Service::experimental().MarkMethodCallback(0,
        new ::grpc::internal::CallbackUnaryHandler< ::v3lockpb::LockRequest, ::v3lockpb::LockResponse>(
          [this](::grpc::ServerContext* context,
                 const ::v3lockpb::LockRequest* request,
    ...
    void SetMessageAllocatorFor_Lock(
      ...
      static_cast<::grpc::internal::CallbackUnaryHandler< ::v3lockpb::LockRequest, ::v3lockpb::LockResponse>*>(
    ...
    virtual void Lock(::grpc::ServerContext* context, const ::v3lockpb::LockRequest* request, ::v3lockpb::LockResponse* response, ::grpc::experimental::ServerCallbackRpcController* controller) { controller->Finish(::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "")); }
  };
  template <class BaseClass>
   ...
   public:
    ExperimentalWithCallbackMethod_Unlock() {
      ::grpc::Service::experimental().MarkMethodCallback(1,
        new ::grpc::internal::CallbackUnaryHandler< ::v3lockpb::UnlockRequest, ::v3lockpb::UnlockResponse>(
          [this](::grpc::ServerContext* context,
                 const ::v3lockpb::UnlockRequest* request,
    ...
    void SetMessageAllocatorFor_Unlock(
      ...
      static_cast<::grpc::internal::CallbackUnaryHandler< ::v3lockpb::UnlockRequest, ::v3lockpb::UnlockResponse>*>(
    ...
    virtual void Unlock(::grpc::ServerContext* context, const ::v3lockpb::UnlockRequest* request, ::v3lockpb::UnlockResponse* response, ::grpc::experimental::ServerCallbackRpcController* controller) { controller->Finish(::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "")); }
  };
