...
void Election::Stub::experimental_async::Campaign(::grpc::ClientContext* context, const ::v3electionpb::CampaignRequest* request, ::v3electionpb::CampaignResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_Campaign_, context, request, response, std::move(f));
}

void Election::Stub::experimental_async::Campaign(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::v3electionpb::CampaignResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_Campaign_, context, request, response, std::move(f));
}

void Election::Stub::experimental_async::Campaign(::grpc::ClientContext* context, const ::v3electionpb::CampaignRequest* request, ::v3electionpb::CampaignResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create(stub_->channel_.get(), stub_->rpcmethod_Campaign_, context, request, response, reactor);
}

void Election::Stub::experimental_async::Campaign(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::v3electionpb::CampaignResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create(stub_->channel_.get(), stub_->rpcmethod_Campaign_, context, request, response, reactor);
}
...
void Election::Stub::experimental_async::Proclaim(::grpc::ClientContext* context, const ::v3electionpb::ProclaimRequest* request, ::v3electionpb::ProclaimResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_Proclaim_, context, request, response, std::move(f));
}

void Election::Stub::experimental_async::Proclaim(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::v3electionpb::ProclaimResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_Proclaim_, context, request, response, std::move(f));
}

void Election::Stub::experimental_async::Proclaim(::grpc::ClientContext* context, const ::v3electionpb::ProclaimRequest* request, ::v3electionpb::ProclaimResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create(stub_->channel_.get(), stub_->rpcmethod_Proclaim_, context, request, response, reactor);
}

void Election::Stub::experimental_async::Proclaim(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::v3electionpb::ProclaimResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create(stub_->channel_.get(), stub_->rpcmethod_Proclaim_, context, request, response, reactor);
}
...
void Election::Stub::experimental_async::Leader(::grpc::ClientContext* context, const ::v3electionpb::LeaderRequest* request, ::v3electionpb::LeaderResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_Leader_, context, request, response, std::move(f));
}

void Election::Stub::experimental_async::Leader(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::v3electionpb::LeaderResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_Leader_, context, request, response, std::move(f));
}

void Election::Stub::experimental_async::Leader(::grpc::ClientContext* context, const ::v3electionpb::LeaderRequest* request, ::v3electionpb::LeaderResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create(stub_->channel_.get(), stub_->rpcmethod_Leader_, context, request, response, reactor);
}

void Election::Stub::experimental_async::Leader(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::v3electionpb::LeaderResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create(stub_->channel_.get(), stub_->rpcmethod_Leader_, context, request, response, reactor);
}
...
void Election::Stub::experimental_async::Observe(::grpc::ClientContext* context, ::v3electionpb::LeaderRequest* request, ::grpc::experimental::ClientReadReactor< ::v3electionpb::LeaderResponse>* reactor) {
  ::grpc::internal::ClientCallbackReaderFactory< ::v3electionpb::LeaderResponse>::Create(stub_->channel_.get(), stub_->rpcmethod_Observe_, context, request, reactor);
}
...
void Election::Stub::experimental_async::Resign(::grpc::ClientContext* context, const ::v3electionpb::ResignRequest* request, ::v3electionpb::ResignResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_Resign_, context, request, response, std::move(f));
}

void Election::Stub::experimental_async::Resign(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::v3electionpb::ResignResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_Resign_, context, request, response, std::move(f));
}

void Election::Stub::experimental_async::Resign(::grpc::ClientContext* context, const ::v3electionpb::ResignRequest* request, ::v3electionpb::ResignResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create(stub_->channel_.get(), stub_->rpcmethod_Resign_, context, request, response, reactor);
}

void Election::Stub::experimental_async::Resign(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::v3electionpb::ResignResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create(stub_->channel_.get(), stub_->rpcmethod_Resign_, context, request, response, reactor);
}
